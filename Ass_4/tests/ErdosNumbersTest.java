...
//            "Tight bounds on the:Thom|Paul|Alav|Mald|Schw",
//            "Some complete bipar:Burr|Paul|Faud|Rous|Sche",
//            "Vertex-distinguishi:Burr|Sche",
//            "Adjacent vertex dis:Bali|Gyor|Lehe|Sche",
//            "Sur les fonctions a:Paul|Tene",
//            "Integers without la:Hild|Tene",
//            "Vertex‐distinguishi:Bali|Rior|Sche",
//            "TTTTTTTTTTTTTTTTTTT:Test"
    ...
    public void simpleWeightedTest() {
        ...
        assertEquals(Double.MAX_VALUE, nums.calculateWeightedErdosNumber("Test"), 0.001);
    }
...
//        System.out.println(nums.isErdosConnectedToAll());
        assertTrue(nums.isErdosConnectedToAll());
    }
